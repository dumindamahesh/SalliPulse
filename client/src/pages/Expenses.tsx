  ...
  return (
    <div className="space-y-6 animate-slide-up">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-gradient">Expenses</h1>
          <p className="text-muted-foreground">Monitor your spending with deep insights</p>
        </div>
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-black text-white tracking-widest uppercase">Expense History</h2>
